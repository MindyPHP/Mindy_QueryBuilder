...
class BuildJoinTest extends BaseTest
{
    ...
    public function testAlias()
    {
        ...
        $this->assertSame(' LEFT JOIN test AS test_user ON main.user_id=test_user.id', $qb->buildJoin());
    ...
    public function testSimpleRaw()
    {
        ...
        $this->assertSame(' LEFT JOIN test ON test.id = foo.bar_id', $qb->buildJoin());
    }
    ...
    public function testSimpleClone()
    {
        ...
        $clone = clone $qb;
        $this->assertSame(' LEFT JOIN test ON id=user_id', $clone->buildJoin());
    }
    ...
    public function testMultiple()
    {
        ...
        $this->assertSame(' LEFT JOIN test ON id=user_id INNER JOIN user ON parent_id=id', $qb->buildJoin());
    }
    ...
    public function testExpression()
    {
        ...
        $this->assertSame(' LEFT JOIN test ON user_id=1', $qb->buildJoin());
    }
    ...
    public function testSelectAutoJoin()
    {
        ...
        $this->assertSame(' LEFT JOIN user AS user_1 ON user_1.id=customer.user_id', $qb->buildJoin());
    }
    ...
    public function testSelectAutoJoinAggregation()
    {
        ...
        $this->assertSame('SELECT MIN(user_1.id) AS id_min, MAX(user_1.id) AS id_max FROM customer LEFT JOIN user AS user_1 ON user_1.id=customer.user_id', $qb->toSQL());
        $this->assertSame(' LEFT JOIN user AS user_1 ON user_1.id=customer.user_id', $qb->buildJoin());
    }
}
