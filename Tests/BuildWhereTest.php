...
class BuildWhereTest extends BaseTest
{
    ...
    public function testHard()
    {
        ...
        $this->assertSame($subQuerySql, $subQuery->toSQL());
        ...
        $this->assertSame('SELECT test_1.id, test_1.root, test_1.lft, test_1.rgt, test_1.rgt-test_1.lft-1 AS move', $query->buildSelect());
        $this->assertSame('SELECT test_1.id, test_1.root, test_1.lft, test_1.rgt, test_1.rgt-test_1.lft-1 AS move FROM test AS test_1 WHERE (NOT (test_1.lft = test_1.rgt-1 AND test_1.id IN ('
